...
import type {GitHubModelsChatModelId} from './options'
...
export interface GitHubModelsProvider extends ProviderV2 {
  ...
  */
  textEmbeddingModel(modelId: GitHubModelsChatModelId): EmbeddingModelV2<string>
}

export function createGitHubModels(options: GitHubModelsProviderSettings = {}): GitHubModelsProvider {
  ...
  provider.textEmbeddingModel = (modelId: string) => new OpenAICompatibleEmbeddingModel(modelId, baseOptions)
